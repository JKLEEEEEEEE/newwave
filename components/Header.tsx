...
interface Props {
  onViewChange: (view: 'analysis' | 'monitoring' | 'global' | 'risk' | 'risk-v2') => void;
  currentView: 'analysis' | 'monitoring' | 'global' | 'risk' | 'risk-v2';
  crisisAlert?: boolean;
}
    ...
    <header className="h-16 flex items-center justify-between px-8 bg-[#003366] border-b border-white/10 z-50">
      ...
      <nav className="flex items-center h-full text-[11px] font-bold uppercase tracking-widest">
        ...
        <NavItem
          ...
          label="공급망 리스크"
          icon={<svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" strokeWidth={2.5}/></svg>}
        />
        <NavItem
